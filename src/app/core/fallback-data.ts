...
export const TESTIMONIOS_FALLBACK: Testimonio[] = [
  {
    ...
    nombre: 'Lucía',
    comentario:
      'La torta de chocolate fue el centro del cumple. ¡Húmeda, intensa y hermosa! Repetimos seguro.',
    estrellas: 5,
    visible: true,
  },
  {
    ...
    nombre: 'Federico',
    comentario:
      'Pedí un box dulce para sorprender a mi novia y llegó impecable. Se nota lo casero en cada bocado.',
    estrellas: 5,
    visible: true,
  },
  {
    ...
    nombre: 'Carla',
    comentario:
      'El cheesecake de frutos rojos es de otro planeta. Atención súper cálida y entrega puntual.',
    estrellas: 5,
    visible: true,
  },
];
...
export const PRODUCTOS_FALLBACK: Producto[] = [
  {
    ...
    descripcion:
      'Bizcochuelo húmedo de cacao, ganache de chocolate semiamargo y un toque de dulce de leche.',
    precio: 1450,
    categoria: 'Tortas',
  ...
  },
  {
    ...
    descripcion:
      'Selección de 12 mini postres: brownies, alfajores de maicena, mini lemon pie y trufas.',
    precio: 990,
  ...
  },
  {
    ...
    descripcion:
      'Diseñada a medida para tu evento: elegí sabor, relleno y decoración. Pedinos un presupuesto.',
    precio: 2200,
